exports.getMimeForFsSync = function(fs,extname){  /*使用同步读取文件 获取后缀名的方法*/
...
exports.getMimeForFs = function(fs,extname,callback){  /*使用异步读取文件 获取后缀名的方法*/

    //把读取数据改成同步
    var data = fs.readFile('../json/mime.json',function (err,data) {
        if (err) {
            console.log(err);
            return false;
        }
